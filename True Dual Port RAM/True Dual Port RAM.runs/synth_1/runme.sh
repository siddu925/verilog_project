...
HD_PWD='C:/Users/sidde/Desktop/Verilog/True Dual Port RAM/True Dual Port RAM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dual_port_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dual_port_ram.tcl
