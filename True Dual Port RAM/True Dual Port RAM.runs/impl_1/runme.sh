...
HD_PWD='C:/Users/sidde/Desktop/Verilog/True Dual Port RAM/True Dual Port RAM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dual_port_ram.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dual_port_ram.tcl -notrace
