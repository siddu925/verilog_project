...
HD_PWD='C:/Users/sidde/Desktop/Verilog/riscv_alu/riscv_alu.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log riscv32_alu.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source riscv32_alu.tcl -notrace
