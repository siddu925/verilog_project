...
HD_PWD='C:/Users/sidde/Desktop/Verilog/riscv_alu/riscv_alu.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log riscv32_alu.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source riscv32_alu.tcl
