...
HD_PWD='C:/Users/sidde/Desktop/Verilog/vm_coin/vm_coin.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vm_add_coins.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vm_add_coins.tcl -notrace
