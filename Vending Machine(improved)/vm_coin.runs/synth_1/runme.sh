...
HD_PWD='C:/Users/sidde/Desktop/Verilog/vm_coin/vm_coin.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vm_add_coins.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vm_add_coins.tcl
