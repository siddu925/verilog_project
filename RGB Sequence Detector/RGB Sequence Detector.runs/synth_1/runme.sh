...
HD_PWD='C:/Users/sidde/Desktop/Verilog/RGB Sequence Detector/RGB Sequence Detector.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rgb_no_overlap.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rgb_no_overlap.tcl
