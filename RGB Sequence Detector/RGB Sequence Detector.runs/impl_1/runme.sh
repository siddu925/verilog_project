...
HD_PWD='C:/Users/sidde/Desktop/Verilog/RGB Sequence Detector/RGB Sequence Detector.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rgb_no_overlap.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rgb_no_overlap.tcl -notrace
